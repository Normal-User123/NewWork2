...
def runScheduler():
    while True:
        ...
        # Calculate the offset for UTC+5:30 (5 hours 30 minutes = 19800 seconds)
        utc_plus_530 = time.gmtime(time.mktime(utc_time) + 19800)
        # Format and print the current UTC+5:30 timestamp
        print("Current UTC+5:30 timestamp:", time.strftime('%Y-%m-%d %H:%M:%S', utc_plus_530),"Scheduler running...")
